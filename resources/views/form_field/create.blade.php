<x-app-layout>
        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
          <div class="md:col-span-1">
            <div class="px-4 sm:px-0">
              <h3 class="text-lg font-medium leading-6 text-gray-900">Add form fields</h3>
            </div>
          </div>
          <div class="mt-5 md:mt-0 md:col-span-2">
            <form action="{{ route('form_field.store') }}" method="POST">
              @csrf
                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                  <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-8 sm:col-span-6">
                      ...
                      <input type="text" name="label" id="label" autocomplete="label" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                      @error('label')
                    ...
                    <div class="col-span-8 sm:col-span-6">
                      ...
                      @enderror
                      <div id="div_for_select_option_button_div">
  ...
  <script>
    $('#field_type').change(function (e) { 
      e.preventDefault();
      if (this.value == 3) {
        $('#div_for_select_option_button_div').html("<button class='bg-blue-500 hover:bg-blue-700 text-white rounded-full mt-4' id='div_for_select_option_button'><svg class='w-6 h-6' fill='none' stroke='currentColor' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M12 6v6m0 0v6m0-6h6m-6 0H6'></path></svg></button>");
        $('#div_for_select_option').html("<input type='text' name='option[]' id='option' autocomplete='option' class='mt-4 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md'>");
      } else {
        $('#div_for_select_option_button_div').html("");
        $('#div_for_select_option').html("");
      }
    });

    $('#div_for_select_option_button_div, #div_for_select_option_button').click(function (e) { 
      e.preventDefault();

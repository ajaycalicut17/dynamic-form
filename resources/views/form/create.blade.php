        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
          <div class="md:col-span-1">
            <div class="px-4 sm:px-0">
              <h3 class="text-lg font-medium leading-6 text-gray-900">Add form</h3>
            </div>
          </div>
                      ...
                      <div class="mt-4 space-y-4">
                        ...
                        <div class="flex items-start">
                          <div class="flex items-center h-5">
                            <input id="form_field_{{ $index }}" name="form_field[]" type="checkbox" value="{{ $form_field->id }}" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                          </div>
